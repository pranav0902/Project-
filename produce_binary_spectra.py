...
def create_binary_spectrum(stellar_labels_1,stellar_labels_2,rv_1,rv_2):
	model_flux_1 = model(stellar_labels_1).flatten()
	model_flux_2 = model(stellar_labels_2).flatten()
	pixels_of_1 = [wavelength*(1+(rv_1/c)) for wavelength in dispersion]
	pixels_of_2 = [wavelength*(1+(rv_2/c)) for wavelength in dispersion]
	...
	ax[0].plot(new_wavelengths,new_fluxes,'b')
	ax[1].plot(new_wavelengths,new_fluxes,'g')
	ax[2].plot(new_wavelengths,new_fluxes,'r')
	ax[3].plot(new_wavelengths,new_fluxes,'k')
	ax[0].set_xlim([4710,4900])
	ax[1].set_xlim([5600,5900])
	ax[2].set_xlim([6450,6800])
	ax[3].set_xlim([7650,7900])
	ax[0].set_title('blue arm')
	ax[1].set_title('green arm')
	ax[2].set_title('red arm')
	ax[3].set_title('infrared arm')
	plt.show()
